...
const REFUSAL_PATTERNS = [
  ...
  /אני לא (?:יכול|מסוגל|מורשה|רשאי)/,
  /איני (?:יכול|מסוגל|מורשה|רשאי)/,
  /לא (?:אוכל|ניתן) (?:לעזור|לסייע)/,
  /אין באפשרותי/,
  /אין ביכולתי/,
  /אין לי אפשרות (?:לעזור|לסייע|לספק)/,
  /חורג מההנחיות/,
  /(?:לא (?:אוכל|ניתן|יכול) לסייע)/,
  /(?:מסוג זה|בקשה זו|בנושא זה).*(?:לא|אין|איני)/,
  /(?:לא|אין|איני).*(?:מסוג זה|בקשה זו|בנושא זה)/,
];
